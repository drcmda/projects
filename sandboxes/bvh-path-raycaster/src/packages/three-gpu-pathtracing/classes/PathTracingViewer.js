import { Scene, WebGLRenderer, MeshBasicMaterial, Vector2, Mesh, PerspectiveCamera, sRGBEncoding, HemisphereLight, DoubleSide } from 'three'
...
export class PathTracingViewer {
  ...
  setModel(object, bvhOptions = {}) {
    ...
    return this.bvhGenerator.generate(geometry, { strategy: SAH, maxLeafTris: 1, ...bvhOptions }).then((bvh) => {
      if (this._nextObject) {
