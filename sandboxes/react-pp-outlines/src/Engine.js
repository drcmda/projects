  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <Select enabled={config.all}>
        <Select name="gear" enabled={config.gear}>
        ...
        <Select name="shaft" enabled={config.shaft}>
        ...
        <Select name="cylinder" enabled={config.cylinder}>
        ...
        <Select name="piston1" enabled={config.piston1}>
        ...
        <Select name="piston2" enabled={config.piston2}>
        ...
        <Select name="piston3" enabled={config.piston3}>
