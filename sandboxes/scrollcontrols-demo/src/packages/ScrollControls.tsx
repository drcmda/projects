...
export function ScrollControls({ eps = 0.00001, horizontal, pages = 1, distance = 1, damping = 4, children }: ScrollControlsProps) {
  ...
  }, [state, invalidate, distance, damping, pages, horizontal])
